...
public class Datos {
    ...
    void menu(){
        ...
        while(var.equalsIgnoreCase("si")){
            ...
            + "2.Mostrar lso datos de los estudiantes \n"));
    ...
    public void pedirEstudiante(){
        //solicito los datos
        int numbol = Integer.parseInt(JOptionPane.showInputDialog("Ingresa el numero de boleta del estudiante"));
        ...
        //en este arreglo estudio guardando los datos del estudinte
        obj[x] = new Estudiante(numbol, nom, edad, gen);
        x++;
    }

    public void mostrarEstudiante(){
        //necesito el get para cada uno de los datos en el arreglo
        for(int i = 0; i <x; i++){
            //visualiso
